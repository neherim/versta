...
stubProjectSchema =
  let
    service1 = Service
      ...
      , _serviceInPorts     = [ Port { _portId   = uuid "ea169016-b08c-41c6-9c4e-a87c3522c287"
                                     , _portName = "CreateOrder"
                                     }
                              , Port { _portId   = uuid "8a87d0e7-3b95-4eaf-9774-fd28fc593bfe"
                                     , _portName = "RefundOrder"
                                     }
                              ]
      , _serviceOutPorts     =
        [ Port { _portId = uuid "4596e3ef-59d1-4667-8c78-28bc46dab4a2", _portName = "OrderCreated" }
        , Port { _portId = uuid "e52e3863-2f47-44e2-bcaf-4635a0b02ac4", _portName = "OrderRefunded" }
        ]
      }
    service2 = Service
      ...
      , _serviceInPorts     = [ Port { _portId   = uuid "0fa043ce-5ece-4d00-83a0-10cb412ff29e"
                                     , _portName = "OrderCreated"
                                     }
                              ]
      , _serviceOutPorts    =
        [ Port { _portId = uuid "a762c054-c174-4880-92a3-9b5e08cec5a9", _portName = "NotificationCreated" }
        ]
      }
  ...
  in
    return ProjectSchema { _projectSchemaId       = uuid "58b1d03d-748b-4db6-983f-b7bdbb2873af"
